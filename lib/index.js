...
exports.log = {
    ...
    error: function (msg) { if (exports.LEVEL >= exports.ERROR) {
        console.error("[ERROR]  : " + msg);
    } },
    warn: function (msg) { if (exports.LEVEL >= exports.WARN) {
        console.error("[WARNING]: " + msg);
    } },
    info: function (msg) { if (exports.LEVEL >= exports.INFO) {
        console.log("[info]   : " + msg);
    } },
    debug: function (msg) { if (exports.LEVEL >= exports.DEBUG) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            program.version("0.1.0")
                ...
                .option("-v, --verbose", "Log Verbose Output", function () { if (exports.LEVEL < exports.INFO) {
                exports.LEVEL = exports.INFO;
            } })
                .option("-d, --debug", "Log Debug Output", function () { if (exports.LEVEL < exports.DEBUG) {
                exports.LEVEL = exports.DEBUG;
            } })
            ...
            program.command("color")
                ...
                .action(function (red, green, blue) {
                exports.log.info("(" + red + ", " + green + ", " + blue + ")");
                var bulb = new FluxBulb_1.FluxBulb(host, port, opts);
